# Ranking Check - greenh2sAI - C2.5

**Entity:** greenh2s · **Model:** composer-2.5
...
| Field | Value |
|-------|-------|
| **Automation** | Ranking Check - greenh2sAI - C2.5 |
| **Entity** | greenh2s.ai (https://www.greenh2s.ai) |
| **Cursor model** | composer-2.5 (Composer 2.5) |
...
- **Listed strength:** Fast structured generic-topic ranking probes
- Use this model's perspective for the Cursor-side assessment o…