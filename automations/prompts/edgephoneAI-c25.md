# Ranking Check - EdgephoneAI - C2.5

**Entity:** edgephone · **Model:** composer-2.5
...
| Field | Value |
|-------|-------|
| **Automation** | Ranking Check - EdgephoneAI - C2.5 |
...
- Use this model's perspective for the Cursor-side …