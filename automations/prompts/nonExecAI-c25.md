# Ranking Check - NonExecAI - C2.5

**Entity:** non-exec · **Model:** composer-2.5
...
| Field | Value |
|-------|-------|
| **Automation** | Ranking Check - NonExecAI - C2.5 |
...
3. Mirror changes to `meta/agent-prompts-used.json` → `entities.non-e…