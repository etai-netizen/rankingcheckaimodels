# Ranking Check - EdgephoneAI - G5.5H

**Entity:** edgephone · **Model:** gpt-5.5-high
...
| Field | Value |
|-------|-------|
| **Automation** | Ranking Check - EdgephoneAI - G5.5H |
...
- **Configured model:** gpt-5.5-high
- **Listed strength:** Cross-platform ranking comparison and prompt refinement
- Use this model's perspective for the …